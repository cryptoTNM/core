...
echo 'alias tnmecosystem="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/cryptoTNM/core" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/cryptoTNM/core'"
...
rm -rf "$HOME/.config/@tnmecosystem"
rm -rf "$HOME/.config/@tnmecosystem"
rm -rf "$HOME/.config/tnmecosystem-core"
